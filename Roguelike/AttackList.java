public class AttackList {
    public static Attack[] attacks = {
        ...
        new Attack("Megastrike", true, new Effect[] {new Effect(Effect.EffectEnum.DAMAGE, 1, 40)}, new Effect[] {}, Shop.Rarity.RARE, "Deal 40 damage", 0),
        new Attack("Sacrificial Strike", true, new Effect[] {new Effect(Effect.EffectEnum.DAMAGE, 1, 30)}, new Effect[] {new Effect(Effect.EffectEnum.PERCENTDAMAGE, 1, 30)}, Shop.Rarity.UNCOMMON, "Sacrifice 30% of your health to deal 30 damage", -1)
    };
}
